...
const Header = ({ role }: THeaderProps) => {
  return (
    <header className="w-full p-4 py-2 lg:pt-3 lg:px-6 border-b lg:border-none sticky lg:static top-0 bg-white  flex items-center justify-between">
      ...
      <div className="flex items-center gap-2 lg:gap-4">
        <a href="" className=" text-neutral-500 capitalize hover:text-black text-sm">
          changelog
        </a>
        <a href="" className=" text-neutral-500 capitalize hover:text-black text-sm">
          help
